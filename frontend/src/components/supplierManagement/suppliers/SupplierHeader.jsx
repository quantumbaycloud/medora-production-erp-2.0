      ...
      <div className="relative flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-start gap-4">
          <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-primary shadow-lg shadow-primary-fixed/50">
            <Building2 size={24} className="text-on-primary" />
          </div>
          ...
          <div>
            ...
            <div className="mt-3 flex items-center gap-4 text-xs text-outline">
              <span className="inline-flex items-center gap-1.5">
                ...
                <span className="font-semibold text-on-surface-variant">5</span> Suppliers
              </span>
              <span className="h-3 w-px bg-surface-container-high" />
              <span>
                <span className="font-semibold text-secondary">3</span> Active
              </span>
              <span className="h-3 w-px bg-surface-container-high" />
              <span>
                <span className="font-semibold text-tertiary">1</span> Pending
              </span>
            </div>
          </div>
        </div>
        ...
        <button
          onClick={onAddClick}
          className="inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-5 py-2.5 text-sm font-semibold text-on-primary shadow-md shadow-primary-fixed/50 transition-all duration-200 hover:shadow-lg hover:shadow-primary-fixed-dim/50 hover:opacity-95 focus:outline-none focus:ring-2 focus:ring-primary/50"
        >
          <Plus size={18} />
